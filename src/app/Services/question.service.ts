...
export class QuestionService {
  ...
  postExamAnswer(quizId:number,AnswerRequestDTO: AnswerRequestDTO[], attemptId:number):Observable<answerResponseDTO>{
    return this.http.post<answerResponseDTO>(`${this.API_URL}/postAnswer/${quizId}?attemptId=${attemptId}`,AnswerRequestDTO)
  }
