...
export class QuizFormComponent implements OnInit {
  ...
  @ViewChild('submitExam') examModal!: TemplateRef<any>
  ...
  constructor(private route:ActivatedRoute,
    ...
    ngOnInit(): void {
      ...
      openSubmit(){
        this.modalService.open(this.examModal)
      ...
      submittt(){
        Swal.fire({  
          ...
          text: 'Sau khi nhấn nộp sẽ không thể hoàn tác!',  
          icon: 'warning',  
      ...
      submitForm(){
        ...
        this.QuestionService.postExamAnswer(this.id,this.answerForm.value,this.attemptId).subscribe(
          value => {
            const ids:number[] = []
